                    ...
                    <b-menu-list label="Menu">
                        ...
                        <b-menu-item icon="settings">
                            <template slot="label" slot-scope="props">
                                ...
                                <span><b-icon icon="checkerboard" class="is-pulled-left" />Parties</span>
                        ...
                        <b-menu-item icon="strategy" label="Stratagèmes" tag="router-link" :to="{ name: 'stratagem-list' }" class="is-6"></b-menu-item>
